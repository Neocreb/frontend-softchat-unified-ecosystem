...
const SellerDashboard = () => {
  ...
  const mockOrders: Order[] = [
    { id: '1', productName: 'Wireless Headphones', customerName: 'John Doe', amount: 99.99, status: 'pending', date: '2025-01-06', quantity: 1 },
    { id: '2', productName: 'Smart Watch', customerName: 'Jane Smith', amount: 199.99, status: 'shipped', date: '2025-01-05', quantity: 2 },
    { id: '3', productName: 'Phone Case', customerName: 'Bob Johnson', amount: 29.99, status: 'delivered', date: '2025-01-04', quantity: 1 },
  ];
  ...
  return (
    <div className="space-y-6 p-4 md:p-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <Button onClick={handleCreateListing} className="flex items-center gap-2 w-full sm:w-auto">
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-lg font-bold">${analytics.totalSales.toLocaleString()}</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-lg font-bold">{analytics.totalProducts}</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-lg font-bold">{analytics.averageRating}/5</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
            ...
            <CardContent>
              <div className="space-y-4">
                {mockOrders.map((order) => (
                  <div key={order.id} className="flex flex-col lg:flex-row lg:items-center justify-between p-4 border rounded-lg gap-4">
                    <div className="flex-1">
