      ...
      <DialogContent className="sm:max-w-md">
        ...
        {isProcessing ? (
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-softchat-primary/10 to-purple-500/10 rounded-lg p-4 space-y-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <Star className="h-5 w-5 text-yellow-500" />
                  <span className="font-semibold">{formatNumber(currentSoftPoints)} SP</span>
                </div>
            ...
            {/* Withdrawal Method */}
            <div className="space-y-3">
              <Label htmlFor="method">Transfer To</Label>
