      ...
      <div className="container-wide relative z-10">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Link to="/auth">
              <Button size="lg" className="btn-primary text-lg px-8 py-6 rounded hover:bg-blue-700">
                Launch App
              </Button>
            </Link>
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-softchat-200 hover:bg-softchat-50 text-softchat-700 text-lg px-8 py-6"
            >
              Join Waitlist
            </Button>
             </a>
