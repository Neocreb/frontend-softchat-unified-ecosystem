...
const MarketplaceCart = () => {
  const { cart, updateCartQuantity, removeFromCart, clearCart, getCartTotal } = useMarketplace();
                  ...
                  <div key={item.productId} className="py-4 flex flex-col sm:flex-row gap-4">
                    ...
                    <div className="flex-1">
                      <div className="flex flex-col sm:flex-row sm:justify-between gap-3">
                        <div>
                          <Badge variant="outline" className="mb-1">{item.product.category}</Badge>
                          <h3 
                      ...
                      <div className="mt-2 text-right text-sm font-semibold">
                        Subtotal: ${((item.product.discountPrice || item.product.price) * item.quantity).toFixed(2)}
                      </div>
                    </div>
                  </div>
                ))}
