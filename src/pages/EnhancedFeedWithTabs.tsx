          ...
          ...(userStories.length > 0 ? [{
            ...
            stories: userStories.map(story => ({
              ...
              user: {
                ...
                username: (story.user?.name || "user").toLowerCase().replace(' ', '_'),
                avatar: story.user?.avatar || "https://api.dicebear.com/7.x/avataaars/svg?seed=user",
              },
              ...
              textContent: story.content?.text || story.text || "Sample story content",
              backgroundColor: 'bg-gradient-to-br from-blue-400 to-purple-600',
              textColor: 'text-white',
              timestamp: story.timestamp ? (typeof story.timestamp === 'string' ? story.timestamp : story.timestamp.toISOString()) : new Date().toISOString(),
              duration: 5,
              privacy: 'public',
              views: story.views || 0,
