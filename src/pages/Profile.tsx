...
const Profile = () => {
  ...
  const mockPosts = [
    ...
    },
    {
      id: "3",
      content:
        "Attended an amazing tech conference today! Learned so much about AI and machine learning trends for 2024.",
      images: [],
                ...
                <div className="grid grid-cols-2 gap-4 text-center">
                  <div>
                    <div className="text-2xl font-bold text-blue-600">
                      {mockProfile.socialStats.totalLikes}
                    </div>
                  ...
                  <div>
                    <div className="text-2xl font-bold text-green-600">
                      {mockProfile.socialStats.profileViews}
                    </div>
                    <div className="text-xs text-muted-foreground">
                      Profile Views
                    </div>
                  ...
                  <div>
                    <div className="text-2xl font-bold text-purple-600">
                      {mockProfile.socialStats.totalShares}
                    </div>
                    <div className="text-xs text-muted-foreground">
                      Total Shares
                    </div>
                  ...
                  <div>
                    <div className="text-2xl font-bold text-orange-600">
                      {mockProfile.socialStats.totalComments}
                    </div>
                    <div className="text-xs text-muted-foreground">
                      Comments
                    </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-2 text-sm text-muted-foreground">
                        <div className="flex items-center gap-2">
                          ...
                          <span>
                            Software Developer at {mockProfile.company}
                          </span>
                        </div>
                        <div className="flex items-center gap-2">
