...
// Comprehensive mock data with all platform features
const getMockNotifications = (): EnhancedNotification[] => [
  ...
  },
  {
    ...
    category: "social",
    title: "Post Liked",
    message: "Mike Chen and 12 others liked your post",
    timestamp: new Date(Date.now() - 15 * 60 * 1000),
    read: false,
    priority: "low",
    avatar: "/api/placeholder/40/40",
    actionUrl: "/app/feed/post/123",
    actionLabel: "View Post",
    metadata: { postId: "123", likeCount: 13 },
  },
  {
    id: "3",
    type: "social",
    category: "social",
    title: "New Comment",
    message: "Alex Rivera commented: \"Great insights! Thanks for sharing.\"",
    timestamp: new Date(Date.now() - 30 * 60 * 1000),
    read: true,
    priority: "medium",
    avatar: "/api/placeholder/40/40",
    actionUrl: "/app/feed/post/456",
    actionLabel: "Reply",
    metadata: { postId: "456", commentId: "789" },
  },
  ...
  // Chat notifications
  {
    ...
    metadata: { chatId: "emma-wilson", messagePreview: "Hey! Are you available for a quick call?" },
  },
  {
    id: "5",
    type: "chat",
    category: "chat",
    title: "Group Chat",
    message: "You were added to \"Project Alpha Team\"",
    timestamp: new Date(Date.now() - 45 * 60 * 1000),
    read: false,
    priority: "medium",
    actionUrl: "/app/chat/group/project-alpha-team",
    actionLabel: "Join Chat",
    metadata: { groupId: "project-alpha-team", memberCount: 8 },
  },
  ...
  // Marketplace notifications
  {
    ...
    metadata: { orderId: "MP-12345", trackingNumber: "TRK123456789" },
  },
  {
    id: "7",
    type: "marketplace",
    ...
    message: "David Kim left a 5-star review on your product",
    timestamp: new Date(Date.now() - 2 * 60 * 60 * 1000),
    read: false,
    priority: "low",
    avatar: "/api/placeholder/40/40",
    actionUrl: "/app/marketplace/products/my-product",
    actionLabel: "View Review",
    metadata: { productId: "my-product", rating: 5 },
  },
  ...
  },
  {
    ...
    read: false,
    priority: "urgent",
    actionUrl: "/app/freelance/projects/ecommerce-website",
    actionLabel: "Start Project",
    metadata: { projectId: "ecommerce-website", budget: 2500 },
    starred: true,
  },
  ...
  // Crypto notifications
  {
    ...
    metadata: { symbol: "BTC", price: 45000, change: 5.2 },
  },
  {
    id: "11",
    type: "crypto",
    ...
    message: "Successfully bought 0.1 ETH at $3,200",
    timestamp: new Date(Date.now() - 6 * 60 * 60 * 1000),
    read: true,
    priority: "medium",
    actionUrl: "/app/crypto/portfolio",
    actionLabel: "View Portfolio",
    metadata: { symbol: "ETH", amount: 0.1, price: 3200 },
  },
  ...
  // Videos notifications
  {
    ...
    message: "Your video \"React Tips\" is trending with 10K views",
    timestamp: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000),
    read: true,
    priority: "high",
    actionUrl: "/app/videos/react-tips",
    actionLabel: "View Video",
    metadata: { videoId: "react-tips", views: 10000 },
  },
  ...
  // System notifications
  {
    ...
    actionLabel: "Review",
    metadata: { location: "New York, USA", device: "Chrome on Windows" },
  },
];
