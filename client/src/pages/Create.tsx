...
import { Star, MapPin, Clock, DollarSign, Users, Briefcase, Plus, Search, Filter } from "lucide-react";
...
const mockJobOffers: JobOffer[] = [
  {
    ...
    description: 'Looking for an experienced developer to build a comprehensive e-commerce platform with React, Node.js, and MongoDB. Must have experience with payment integration and user authentication.',
    budget: 5000,
    deadline: '2024-02-15',
  ...
  },
  {
    ...
    description: 'Need a talented designer to create a modern, user-friendly mobile app interface for a fitness tracking application. Must provide mockups and prototypes.',
    budget: 75,
    deadline: '2024-01-30',
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-4 text-sm text-muted-foreground">
            <div className="flex items-center gap-1">
              ...
              <span className="font-medium">${job.budget}{job.type === 'hourly' ? '/hr' : ''}</span>
            </div>
            <div className="flex items-center gap-1">
